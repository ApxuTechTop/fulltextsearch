    ...
    class Trie {
        ...
        struct Node {
            ...
            public:
                ...
                explicit Iterator(Node **ptr, std::size_t cur_pos) : children(ptr), pos(cur_pos) {
            ...
            Iterator begin() {
                return Iterator(children, 0);
            }
            Iterator end() {
                return Iterator(children, ALPHABET_SIZE);
            }
            bool is_leaf = false;
            T value;
            char letter;
